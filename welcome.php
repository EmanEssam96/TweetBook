		...
		<main>
			<div class="container2" style="display: inline-block;">
		     ...
		     <div class="Form"  style="display: inline-block;">
		     	<form class="login">
		     		<input type="text" name="userName" placeholder="Phone,email or username" style="margin-top: 8px"><br>
		     		<input type="password" name="password" placeholder="password" style="margin-top: 15px"><br><br>
		     		 <input type="checkbox" name="rememberMe" value="rememberme" ><span style="color: #71797f;">remember me .</span>
		     	...
		     	<form class="signup">
		     		...
		     		<input type="text" name="fullname" placeholder="fullname" style="margin-top: 8px"><br>
		     		<input type="text" name="Email" placeholder="Email" style="margin-top: 8px"><br>
		     		<input type="password" name="password" placeholder="password" style="margin-top: 8px"><br>
